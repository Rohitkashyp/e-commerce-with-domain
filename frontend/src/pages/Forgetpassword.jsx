...
//         return;
//        }
//        const updatedpassword = await axios.patch(`http://localhost:5000/users/${users.id}`,{password:newpassword})
...
//                  <div className='flex justify-center items-center'>
//                   <button type='submit' className='w-[90%] h-10 bg-blue-700 text-white'>Forget Password</button>
//                  </div>
