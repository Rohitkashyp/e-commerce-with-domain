...
//   //  alert("data suceessfully submited")
//   //  console.log("data",{
...
//                                  <select name='paymentMethod' value={formdata.paymentMethod} onChange={handleChange} className='border-[2px] border-gray-400 outline-none w-full h-[40px] text-sm font-medium' >
//                                      <option className='text-sm font-medium' value="" disabled>Select Payment Method</option>
//                                      <option className='text-sm font-medium' value="cashOnDelivery">Cash On delivery</option>
//                                  </select>
//                                  {errors && <p className='text-sm font-medium text-red-500'>{errors.paymentMethod}</p>}
//                                 </div>
//                             </div>
